---
title: "Estimation method on GVA for health and education"
execute: 
  warning: false
format: 
  html:
...
df_QNA_growth <- df_QNA1 %>%
  ...
  mutate(growth = 100*(OBS_VALUE - lag(OBS_VALUE))/lag(OBS_VALUE))
...
df_QNA_growth <- na.omit(df_QNA_growth)
...
####filter through N11G in instr_asset

#df_ANA_growth %>%
#  dplyr::group_by(country, period, subject) %>%
...
# Add grouping for healthcare measure
...
combined_df_ss <- subset(combined_df_a, select=c("country", "period", "method_health", "method_edu", "B1G.P.L", "B1G.P.V", "B1G.Q.L", "B1G.Q.V", "B1G.L", "B1G.V", "B1G.P.P", "B1G.Q.P"))
...
```{r}
ggplot(combined_df_ss, aes(x = period, y = B1G.L, color = factor(method_health), group = factor(method_health))) +
  geom_point(alpha = 0.5) +
  geom_text(aes(label = country), vjust = -0.5, size=2) +
  ggtitle("GVA (volumes) and Year by Health Est. Methods") +
...
```{r}
ggplot(combined_df_ss, aes(x = period, y = B1G.V, color = factor(method_health), group = factor(method_health))) +
  geom_point(alpha = 0.5) +
  geom_text(aes(label = country), vjust = -0.5, size=2) +
  ggtitle("GVA (current prices) and Year by Health Est. Methods") +
  scale_color_discrete(name = "Estimation method", labels = c("Input - indirect", "Input - direct", "Output-indirect", "Output-direct"))  # Custom color labels
...
```{r}
ggplot(combined_df_ss, aes(x = period, y = B1G.V, color = factor(method_edu), group = factor(method_edu))) +
  geom_point(alpha = 0.5) +
  geom_text(aes(label = country), vjust = -0.5, size=2) +
  ggtitle("GVA (current prices) and Year by Education Est. Measures") +
  scale_color_discrete(name = "Estimation method", labels = c("Input - indirect", "Input - direct", "Output-direct"))  # Custom color labels
```

Figure 4

```{r}
ggplot(combined_df_ss, aes(x = period, y = B1G.L, color = factor(method_edu), group = factor(method_edu))) +
  geom_point(alpha = 0.5) +
  geom_text(aes(label = country), vjust = -0.5, size=2) +
  ggtitle("GVA (volumes) and Year by Education Est. Methods") +
  scale_color_discrete(name = "Estimation method", labels = c("Input - indirect", "Input - direct", "Output-direct"))  # Custom color labels
```
...
```{r}
ggplot(combined_df_ss, aes(x = period, y = B1G.Q.V, color = factor(method_health), group = factor(method_health))) +
  geom_point(alpha = 0.5) +
  geom_text(aes(label = country), vjust = -0.5, size=2) +
  ggtitle("GVA.Q (current prices) and Year by Health Est. Methods") +
  scale_color_discrete(name = "Estimation method", labels = c("Input - indirect", "Input - direct", "Output-indirect", "Output-direct"))  # Custom color labels
```
...
```{r}
ggplot(combined_df_ss, aes(x = period, y = B1G.Q.L, color = factor(method_health), group = factor(method_health))) +
  geom_point(alpha = 0.5) +
  geom_text(aes(label = country), vjust = -0.5, size=2) +
  ggtitle("GVA.Q (volumes) and Year by Health Est. Methods") +
...
```{r}
ggplot(combined_df_ss, aes(x = period, y = B1G.P.V, color = factor(method_edu), group = factor(method_edu))) +
  geom_point(alpha = 0.5) +
  geom_text(aes(label = country), vjust = -0.5, size=2) +
  ggtitle("GVA.P (current prices) and Year by Education Est. Methods") +
  scale_color_discrete(name = "Estimation method", labels = c("Input - indirect", "Input - direct", "Output-direct"))
```

Figure 8

```{r}
ggplot(combined_df_ss, aes(x = period, y = B1G.P.L, color = factor(method_edu), group = factor(method_edu))) +
  geom_point(alpha = 0.5) +
  geom_text(aes(label = country), vjust = -0.5, size=2) +
  ggtitle("GVA.P (volumes) and Year by Education Est. Methods") +
  scale_color_discrete(name = "Estimation method", labels = c("Input - indirect", "Input - direct", "Output-direct"))
```
...
ggplot(combined_df_ss, aes(x = period, y = B1G.Q.P, color = factor(method_health), group = factor(method_health))) + 
  geom_point(alpha = 0.5) + 
  geom_text(aes(label = country), vjust = -0.5, size=2) + 
  ggtitle("GVA.Q (implicit prices) and Year by Health Est. Methods") + scale_color_discrete(name = "Estimation method", labels = c("Input - indirect", "Input - direct", "Output-indirect", "Output-direct")) 
```
...
ggplot(combined_df_ss, aes(x = period, y = B1G.P.P, color = factor(method_edu), group = factor(method_edu))) +
  geom_point(alpha = 0.5) + 
  geom_text(aes(label = country), vjust = -0.5, size=2) + 
  ggtitle("GVA.P (implcit prices) and Year by Education Est. Methods") + scale_color_discrete(name = "Estimation method", labels = c("Input - indirect", "Input - direct", "Output-indirect", "Output-direct"))
```
